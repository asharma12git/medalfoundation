      ...
      <section style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ marginBottom: isMobile ? '16px' : '20px' }}>Media Alert strives to empower communities through education, awareness, and humanitarian aid. Our core mission is to:</p>
            ...
            <p style={{ marginBottom: isMobile ? '16px' : '20px' }}>Over the past three decades, Media Alert has made a significant impact on the lives of thousands of people. Our key accomplishments include:</p>
            ...
            <p style={{ marginBottom: isMobile ? '16px' : '20px' }}>Media Alert boasts a wealth of expertise in:</p>
            ...
            <p style={{ marginBottom: isMobile ? '24px' : '32px' }}>By combining these strengths with a deep commitment to social justice, Media Alert continues to make a lasting difference in the lives of those we serve.</p>
            
            <p style={{ marginBottom: isMobile ? '24px' : '32px' }}><strong>ACTIVE VOLUNTEERS/MEMBERS:</strong> 5006</p>
            <p style={{ marginBottom: isMobile ? '24px' : '32px' }}><strong>DISTRICTS COVERED BY OUR PROGRAMS:</strong> 48</p>
            <p style={{ marginBottom: isMobile ? '24px' : '32px' }}><strong>LOCAL PARTNERS:</strong> District Level Hospitals and Health Posts, District Development Committees, Village Development Committees, Youth Clubs, Mothers Groups, Wards, Media, Municipalities, Radio Listeners Groups, Local Theatre Groups, other Local Community Groups, and Civil Societies, etc.</p>
